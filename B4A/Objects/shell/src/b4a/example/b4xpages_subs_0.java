...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _getmanager(_ba).runClassMethod (b4a.example.b4xpagesmanager.class, "_addmenuitem" /*RemoteObject*/ ,(Object)(_b4xpage),(Object)(_title));
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return (b4xpages._mpm);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _getmanager(_ba).runClassMethod (b4a.example.b4xpagesmanager.class, "_findpifromb4xpage" /*RemoteObject*/ ,(Object)(_b4xpage)).getField(false,"Parent" /*RemoteObject*/ ).getField(false,"NativeType" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _getmanager(_ba).runClassMethod (b4a.example.b4xpagesmanager.class, "_getpage" /*RemoteObject*/ ,(Object)(_id));
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _getmanager(_ba).runClassMethod (b4a.example.b4xpagesmanager.class, "_findpifromb4xpage" /*RemoteObject*/ ,(Object)(_b4xpage)).getField(true,"Id" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToBoolean(RemoteObject.solveBoolean("i",b4xpages._mpm, RemoteObject.createImmutable("b4a.example.b4xpagesmanager")));
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _getmanager(_ba).getField(false,"_mainpage" /*RemoteObject*/ );
