...
try {
		Debug.PushSubsStack("Activity_ActionBarHomeClick (b4xpagesdelegator) ","b4xpagesdelegator",10,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (b4xpagesdelegator) ","b4xpagesdelegator",10,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("Activity_PermissionResult (b4xpagesdelegator) ","b4xpagesdelegator",10,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("Create_Menu (b4xpagesdelegator) ","b4xpagesdelegator",10,__ref.getField(false, "ba"),__ref,39);
