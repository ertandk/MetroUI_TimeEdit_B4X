...
try {
		Debug.PushSubsStack("Base_Resize (metroui_timeedit) ","metroui_timeedit",3,__ref.getField(false, "ba"),__ref,203);
...
Debug.locals.put("Height", _height);
 BA.debugLineNum = 203;BA.debugLine="Private Sub Base_Resize (Width As Double, Height A";
...
try {
		Debug.PushSubsStack("Dakika_TextChanged (metroui_timeedit) ","metroui_timeedit",3,__ref.getField(false, "ba"),__ref,168);
...
Debug.locals.put("New", _new);
 BA.debugLineNum = 168;BA.debugLine="Private Sub Dakika_TextChanged (Old As String, New";
Debug.ShouldStop(128);
 BA.debugLineNum = 169;BA.debugLine="Try";
Debug.ShouldStop(256);
try { BA.debugLineNum = 170;BA.debugLine="Log(New.Length)";
Debug.ShouldStop(512);
metroui_timeedit.__c.runVoidMethod ("LogImpl","210027010",BA.NumberToString(_new.runMethod(true,"length")),0);
 BA.debugLineNum = 172;BA.debugLine="If New.Length = 2 And SaniyeVisibleCheck=True Th";
...
if (RemoteObject.solveBoolean("=",_new.runMethod(true,"length"),BA.numberCast(double.class, 2)) && RemoteObject.solveBoolean("=",__ref.getField(true,"_saniyevisiblecheck" /*RemoteObject*/ ),metroui_timeedit.__c.getField(true,"True"))) { 
 BA.debugLineNum = 173;BA.debugLine="Saniye_Text.RequestFocus";
Debug.ShouldStop(4096);
__ref.getField(false,"_saniye_text" /*RemoteObject*/ ).runVoidMethod ("RequestFocus");
 }else 
{ BA.debugLineNum = 175;BA.debugLine="Else if New.Length=0 Then";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("=",_new.runMethod(true,"length"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 177;BA.debugLine="Saat_Text.RequestFocus";
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e9.toString()); BA.debugLineNum = 183;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4194304);
metroui_timeedit.__c.runVoidMethod ("LogImpl","210027023",BA.ObjectToString(metroui_timeedit.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
__ref.getField(false,"_saniye_text" /*RemoteObject*/ ).runMethod(true,"setTextColor",BA.numberCast(int.class, __ref.getField(true,"_textcolor" /*RemoteObject*/ )));
 BA.debugLineNum = 131;BA.debugLine="IME.SetLengthFilter(Saat_Text, 2)";
Debug.ShouldStop(4);
__ref.getField(false,"_ime" /*RemoteObject*/ ).runVoidMethod ("SetLengthFilter",(Object)((__ref.getField(false,"_saat_text" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(int.class, 2)));
 BA.debugLineNum = 132;BA.debugLine="IME.SetLengthFilter(Dakika_Text, 2)";
Debug.ShouldStop(8);
__ref.getField(false,"_ime" /*RemoteObject*/ ).runVoidMethod ("SetLengthFilter",(Object)((__ref.getField(false,"_dakika_text" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(int.class, 2)));
 BA.debugLineNum = 133;BA.debugLine="IME.SetLengthFilter(Saniye_Text, 2)";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("Saat_TextChanged (metroui_timeedit) ","metroui_timeedit",3,__ref.getField(false, "ba"),__ref,138);
...
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
 BA.debugLineNum = 138;BA.debugLine="Private Sub Saat_TextChanged (Old As String, New A";
Debug.ShouldStop(512);
 BA.debugLineNum = 139;BA.debugLine="Try";
Debug.ShouldStop(1024);
try { BA.debugLineNum = 140;BA.debugLine="Log(New.Length)";
Debug.ShouldStop(2048);
metroui_timeedit.__c.runVoidMethod ("LogImpl","29633794",BA.NumberToString(_new.runMethod(true,"length")),0);
 BA.debugLineNum = 146;BA.debugLine="Log(Saat_Text.Text)";
Debug.ShouldStop(131072);
metroui_timeedit.__c.runVoidMethod ("LogImpl","29633800",__ref.getField(false,"_saat_text" /*RemoteObject*/ ).runMethod(true,"getText"),0);
 BA.debugLineNum = 148;BA.debugLine="Dim Saatex As Int = Saat_Text.Text";
Debug.ShouldStop(524288);
_saatex = BA.numberCast(int.class, __ref.getField(false,"_saat_text" /*RemoteObject*/ ).runMethod(true,"getText"));Debug.locals.put("Saatex", _saatex);Debug.locals.put("Saatex", _saatex);
 BA.debugLineNum = 150;BA.debugLine="If Saatex > 12 Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean(">",_saatex,BA.numberCast(double.class, 12))) { 
 BA.debugLineNum = 153;BA.debugLine="Saat_Text.Hint = 0";
Debug.ShouldStop(16777216);
__ref.getField(false,"_saat_text" /*RemoteObject*/ ).runMethod(true,"setHint",BA.NumberToString(0));
 BA.debugLineNum = 154;BA.debugLine="Saat_Text.Text = \"\"";
Debug.ShouldStop(33554432);
__ref.getField(false,"_saat_text" /*RemoteObject*/ ).runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 }else 
{ BA.debugLineNum = 156;BA.debugLine="Else if Saatex <= 12 Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("k",_saatex,BA.numberCast(double.class, 12))) { 
 BA.debugLineNum = 157;BA.debugLine="If New.Length = 2 Then";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("=",_new.runMethod(true,"length"),BA.numberCast(double.class, 2))) { 
 BA.debugLineNum = 158;BA.debugLine="Dakika_Text.RequestFocus";
Debug.ShouldStop(536870912);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e14.toString()); BA.debugLineNum = 164;BA.debugLine="Log(LastException)";
Debug.ShouldStop(8);
metroui_timeedit.__c.runVoidMethod ("LogImpl","29633818",BA.ObjectToString(metroui_timeedit.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Saniye_TextChanged (metroui_timeedit) ","metroui_timeedit",3,__ref.getField(false, "ba"),__ref,187);
...
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
 BA.debugLineNum = 187;BA.debugLine="Private Sub Saniye_TextChanged (Old As String, New";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 188;BA.debugLine="Try";
Debug.ShouldStop(134217728);
try { BA.debugLineNum = 189;BA.debugLine="Log(New.Length)";
Debug.ShouldStop(268435456);
metroui_timeedit.__c.runVoidMethod ("LogImpl","210289154",BA.NumberToString(_new.runMethod(true,"length")),0);
 BA.debugLineNum = 191;BA.debugLine="If New.Length=0 Then";
Debug.ShouldStop(1073741824);
if (RemoteObject.solveBoolean("=",_new.runMethod(true,"length"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 193;BA.debugLine="Dakika_Text.RequestFocus";
Debug.ShouldStop(1);
__ref.getField(false,"_dakika_text" /*RemoteObject*/ ).runVoidMethod ("RequestFocus");
 };
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e7.toString()); BA.debugLineNum = 199;BA.debugLine="Log(LastException)";
Debug.ShouldStop(64);
metroui_timeedit.__c.runVoidMethod ("LogImpl","210289164",BA.ObjectToString(metroui_timeedit.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
